...
#define HOME_Y_BEFORE_X   //JTC               // If G28 contains XY home Y before X
...
// @section bltouch
  ...
  //#define BLTOUCH_FORCE_SW_MODE //JTC
  ...
  #define BLTOUCH_LCD_VOLTAGE_MENU //JTC
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   30 // JTC 30 // (steps/s) Encoder rate for 10x speed
  #define ENCODER_100X_STEPS_PER_SEC  30 //JTC  80 // (steps/s) Encoder rate for 100x speed
#endif
...
//JTC #if HAS_BED_PROBE && EITHER(HAS_MARLINUI_MENU, HAS_TFT_LVGL_UI)
  #define PROBE_OFFSET_WIZARD    //JTC   // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -.0   //JTC
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //JTC
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET   //JTC       // Combine M851 Z and Babystepping
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      60   // JTC 400 (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    40  // JTC (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_12V //JTC MY POWERSUPPLY        // All axes (override below)
